...
class UpcomingtransitionField extends FormField
{
    ...
    private function renderCard(UpcomingTransition $upcoming): string
    {
        $fires = match ($upcoming->status) {
            ...
            default             => HTMLHelper::_('date', $upcoming->firesAt->format('Y-m-d H:i:s'), Text::_('DATE_FORMAT_LC2'))
        ...
        return '<div class="card mb-3">'
            ...
            . '<div class="mb-2">'
            . '<span class="badge bg-secondary">' . htmlspecialchars($upcoming->fromStage, ENT_QUOTES, 'UTF-8') . '</span> '
            . '<span class="icon-arrow-right" aria-hidden="true"></span> '
            . '<span class="badge bg-secondary">' . htmlspecialchars($upcoming->toStage, ENT_QUOTES, 'UTF-8') . '</span>'
            . '</div>'
